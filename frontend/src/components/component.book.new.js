        ...
        <div className="row mt-5">
            <div className="mx-auto col-10 col-md-8 col-lg-6">
                ...
                <div className="form-group">
                    <label for="nameBookInput">Nom</label>
                    <input type="text" onChange={(e)=>setName(e.target.value)} className="form-control" id="nameBookInput"/>
                </div>
                <div className="form-group">
                    <label for="descriptionBookInput">Description</label>
                    <input type="text" onChange={(e)=>setDescription(e.target.value)} className="form-control" id="descriptionBookInput"/>
                </div>
                <div className="form-group">
                    <label for="isbnBookInput">Isbn</label>
                    <input type="text" onChange={(e)=>setIsbn(e.target.value)} className="form-control" id="isbnBookInput"/>
                </div>
                <div className="form-group">
                    <label for="auteurBookInput">Auteur</label>
                    <input type="text" onChange={(e)=>setAuteur(e.target.value)} className="form-control" id="auteurBookInput"/>
                </div>
                <div className="form-group">
                    <label for="editeurBookInput">Editeur</label>
                    <input type="text" onChange={(e)=>setEditeur(e.target.value)} className="form-control" id="editeurBookInput"/>
                </div>
                <div className="form-group">
                    <label for="imageBookInput">Image</label>
                    <input type="text" onChange={(e)=>setImage(e.target.value)} className="form-control" id="imageBookInput"/>
                </div>
                <div className="form-group">
